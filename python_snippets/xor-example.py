...
#net = buildNetwork(2, 1, 1, bias=True) # exercise: setup better structure by experimenting
#^ 2 inputs, 1 hidden and 1 output neuron
...
trainer = BackpropTrainer(net, ds, learningrate=0.9, momentum=0.0, weightdecay=0.0, verbose=False)
