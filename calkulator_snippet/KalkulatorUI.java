...
public class KalkulatorUI extends javax.swing.JFrame
{
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false)
                                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                //.addComponent(jLabel4)//ong
                                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                                //.addComponent(jTextField4, GroupLayout.PREFERRED_SIZE, 252, GroupLayout.PREFERRED_SIZE) //boxes next to and below 0
																				)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
                                                //.addComponent(jTextField10, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)//prostokat przy pamieci
                                                //.addComponent(jLabel7)//pamiec
                                        		))
                                .addGap(8)
                                .addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(3)
                                                //.addComponent(jLabel4)//onp
												)
                                        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
                                                //.addComponent(jTextField4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)//box next to and below 0
    ...
    /**
     * IMP: Znak "=" oraz ONP (odwr�cona notacja polska w okienku "ONP"
     */
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if (pamiec2.endsWith("a"))
        {
            ...
            if (tekstArea.length() > 0 )
            {
                jTextArea1.setText(tekstArea + '\n' + '\n' + wartosc1 + " dzielone modulo na " + wartosc2 + " daje resztę = " + wynik);
            }
            else
            {
                jTextArea1.setText(wartosc1 + " dzielone modulo na " + wartosc2 + " daje resztę = " + wynik);
            }
            jTextField2.setText("");
            jTextField1.setText("");
            jTextField4.setText("");
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        {
            jTextField2.setText("Niestety nie podzielisz przez liczbę ujemną ;/");
        }
    ...
    {
        jTextField2.setText("Sin(podaj liczbę)");
    ...
    {
        jTextField2.setText("Cos(podaj liczbę)");
    ...
    private void jButton28ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        jTextField2.setText("Tan(podaj liczbę)");
    ...
    {
        jTextField2.setText("TanH(podaj liczbę)");
    ...
    {
        jTextField2.setText("Exp(podaj liczbę)");
    ...
    {
        jTextField2.setText("Log(podaj liczbę)");
